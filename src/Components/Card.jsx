        ...
        <div className='footer absolute bottom-0 w-full left-0'>
          <div className='flex items-center py-3 px-8 justify-between'>
            ...
            <span className='w-7 h-7 bg-zinc-700 rounded-full flex items-center justify-center'>
              {data.close ? <IoClose /> : <LuDownload size={18} color='#fff'/>}
          ...
          </div>
          {
            data.tag.isOpen ? (
              ...
              <div className="tag w-full py-4 bg-zinc-600 flex items-center justify-center">
                <h3 className='text-sm font-semibold text-gray-500'>{data.tag.tagTitle}</h3>
              </div>
            )
          }
